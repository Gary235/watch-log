...
// node_modules/@mantine/notifications/esm/use-notifications/use-notifications.js
...
function useNotifications() {
  const context = (0, import_react2.useContext)(NotificationsContext);
  if (!context) {
...
function NotificationContainer(_a) {
  ...
  const hideTimeout = (0, import_react10.useRef)();
  const handleHide = () => {
  ...
  return import_react10.default.createElement(Notification, __spreadProps(__spreadValues2(__spreadValues2({}, notificationProps), others), {
    onClose: handleHide,
...
function useNotificationsState({ limit }) {
  ...
  const updateNotification2 = (notification) => update((notifications) => {
...
function NotificationsProvider(_a) {
  ...
  const previousLength = (0, import_react11.useRef)(0);
  const {
    notifications,
    queue,
    showNotification: showNotification2,
  ...
  const { classes, cx, theme } = NotificationsProvider_styles_default({ zIndex });
  ...
  const items = notifications.map((notification) => import_react11.default.createElement(Transition_default, {
    key: notification.id,
    timeout: duration,
    onEnter: () => refs.current[notification.id].offsetHeight,
    nodeRef: { current: refs.current[notification.id] }
  }, (state) => import_react11.default.createElement(NotificationContainer_default, {
    innerRef: (node) => {
  ...
  return import_react11.default.createElement(NotificationsContext.Provider, {
    value: { notifications, queue }
  }, import_react11.default.createElement(Portal, null, import_react11.default.createElement(Box, __spreadValues4({
    className: cx(classes.notifications, className),
    style,
    sx: __spreadValues4({
      maxWidth: containerWidth
    }, get_position_styles_default(positioning, containerWidth, theme.spacing.md))
  }, others), import_react11.default.createElement(TransitionGroup_default, null, items))), children2);
}
